   ...
   Sub KonekLagi(Optional RowA As Long = 0, Optional ColA As Long = 0)
      ...
      If KonekConn() = True Then
         ...
         If nmTbl = "Kas" Then
            Db = "Masuk" : Kr = "Keluar"
         Else
            Db = "Piutang" : Kr = "Hutang"
         End If

         If Not CkAll.Checked Then
            GetRecGrid(G, "Saldo" & nmTbl & " '" & Format(tglA.Value, "MM/dd/yy hh:mm") & "','" & Format(tglB.Value, "MM/dd/yy hh:mm") & "'")
         Else
            GetRecGrid(G, "Saldo" & nmTbl & " '1977-01-22','" & Format(Now, "MM/dd/yy hh:mm") & "'")
         End If
